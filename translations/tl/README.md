...
![AI Agents para sa mga Nagsisimula](../../translated_images/tl/repo-thumbnailv2.06f4a48036fde647.webp)
...
> **Mas gusto mo bang i-Clona Lokal?**
>
> Kasama sa repositoryong ito ang mahigit 50+ na pagsasalin ng wika na nagpapalaki ng laki ng pag-download. Upang mag-clone nang walang mga pagsasalin, gamitin ang sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Kung nais mo ng karagdagang mga pagsasalin ng mga wika na sinusuportahan nasa [dito](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Ang kurso na ito ay may mga leksyon na sumasaklaw sa mga pangunahing kaalaman sa paggawa ng AI Agents. Bawat leksyon ay tumatalakay sa sarili nitong paksa kaya simulan mo sa kahit saan na gusto mo!

May suporta ito ng maraming wika para sa kursong ito. Pumunta sa aming [mga magagamit na wika dito](#-multi-language-support).

Kung ito ang iyong unang pagkakataon na bumuo gamit ang Generative AI models, tingnan ang aming [Generative AI Para sa mga Nagsisimula](https://aka.ms/genai-beginners) na kurso, na may kasamang 21 leksyon sa paggawa gamit ang GenAI.
...
Kung ikaw ay magkakaproblema o may mga tanong tungkol sa paggawa ng AI Agents, sumali sa aming dedikadong Discord Channel sa [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ano ang Kailangan Mo

Bawat leksyon sa kurso na ito ay may kasamang mga halimbawa ng code, na matatagpuan sa folder na code_samples. Maaari mong [i-fork ang repo na ito](https://github.com/microsoft/ai-agents-for-beginners/fork) upang gumawa ng sarili mong kopya.
...
- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Kinakailangan ng Azure Account

Gumagamit ang kursong ito ng mga sumusunod na AI Agent frameworks at serbisyo mula sa Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)


Para sa karagdagang impormasyon ukol sa pagpapatakbo ng code para sa kursong ito, pumunta sa [Course Setup](./00-course-setup/README.md).

## 🙏 Nais mo bang tumulong?

Mayroon ka bang mungkahi o nakakita ng mga pagkakamali sa baybay o code? [Mag-raise ng isyu](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) o [Gumawa ng pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Mga halimbawa ng Python code gamit ang Microsoft Agent Framework sa Azure AI Foundry
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Pambungad sa AI Agents at Mga Gamit ng Agent       | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pagsusuri sa mga AI Agentic Frameworks              | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pattern ng Paggamit ng Tool                      | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pattern ng Pagpaplano                      | [Link](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pattern ng Maramihang Agent                   | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pattern ng Metacognition                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pagsasaliksik sa Microsoft Agent Framework | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Pagbuo ng Computer Use Agents (CUA)        | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
Salamat kay [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) sa pag-ambag ng mahahalagang halimbawa ng code na nagpapakita ng Agentic RAG.
...
Contributor License Agreement (CLA) na nagsasaad na ikaw ay may karapatan at talagang ibinibigay mo sa amin
...
ng CLA at bibigyan ng tamang dekorasyon ang PR (hal., status check, komento). Sundin lamang ang mga tagubiling ibinibigay
ng bot. Isang beses mo lang ito kailangang gawin sa lahat ng mga repo na gumagamit ng aming CLA.
...
makipag-ugnayan sa [opencode@microsoft.com](mailto:opencode@microsoft.com) para sa karagdagang mga tanong o komento.

## Mga Tatak ng Kalakal

Maaaring maglaman ang proyektong ito ng mga tatak ng kalakal o logo para sa mga proyekto, produkto, o serbisyo. Ang awtorisadong paggamit ng mga tatak ng kalakal o logo ng Microsoft ay napapailalim at dapat sumunod sa
[Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Ang paggamit ng mga tatak ng kalakal o logo ng Microsoft sa mga binagong bersyon ng proyektong ito ay hindi dapat magdulot ng kalituhan o magpahiwatig ng pag-sponsor ng Microsoft.
Anumang paggamit ng mga tatak ng kalakal o logo ng third-party ay napapailalim sa mga patakaran ng mga third-party na iyon.
...
Kung mayroon kang puna tungkol sa produkto o mga error habang nagbubuo, bisitahin ang:
...
**Paunawa**:
Ang dokumentong ito ay naisaling-wika gamit ang serbisyong AI na pagsasalin [Co-op Translator](https://github.com/Azure/co-op-translator). Bagamat nagsusumikap kami para sa katumpakan, pakatandaan na ang mga awtomatikong pagsasalin ay maaaring maglaman ng mga error o kamalian. Ang orihinal na dokumento sa kanyang sariling wika ang dapat ituring na pinakapinagkukunan. Para sa mahahalagang impormasyon, inirerekomenda ang propesyonal na pagsasalin ng tao. Hindi kami mananagot sa anumang hindi pagkakaunawaan o maling interpretasyon na nagmumula sa paggamit ng pagsasaling ito.
