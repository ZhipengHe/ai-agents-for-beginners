...
![AI agenti pro začátečníky](../../translated_images/cs/repo-thumbnailv2.06f4a48036fde647.webp)

## Kurz, který vás naučí vše, co potřebujete vědět, abyste mohli začít vytvářet AI agenty

[![GitHub licence](https://img.shields.io/github/license/microsoft/ai-agents-for-beginners.svg)](https://github.com/microsoft/ai-agents-for-beginners/blob/master/LICENSE?WT.mc_id=academic-105485-koreyst)
[![GitHub přispěvatelé](https://img.shields.io/github/contributors/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
> ```
>
> Díky tomu dostanete vše, co potřebujete ke zvládnutí kurzu, a stahování bude výrazně rychlejší.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Pokud chcete mít k dispozici další překlady jazyků, jsou uvedeny [zde](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

[![GitHub sledující](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
[![GitHub hvězdy](https://img.shields.io/github/stars/microsoft/ai-agents-for-beginners.svg?style=social&label=Star)](https://GitHub.com/microsoft/ai-agents-for-beginners/stargazers/?WT.mc_id=academic-105485-koreyst)
...
Tento kurz obsahuje lekce pokrývající základy tvorby AI agentů. Každá lekce zahrnuje své vlastní téma, takže začněte, kde chcete!

Tento kurz má podporu více jazyků. Přejděte na naše [dostupné jazyky zde](#-multijazycnápodpora).

Pokud tvoříte poprvé s generativními AI modely, podívejte se na náš kurz [Generative AI pro začátečníky](https://aka.ms/genai-beginners), který obsahuje 21 lekcí o tvorbě s GenAI.

Nezapomeňte [ohvězdičkovat (🌟) tento repozitář](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [forknout tento repozitář](https://github.com/microsoft/ai-agents-for-beginners/fork), abyste mohli spouštět kód.

### Setkejte se s dalšími studenty, nechte si odpovědět na své otázky

Pokud se zaseknete nebo máte jakékoli dotazy ohledně tvorby AI agentů, připojte se na náš zvláštní kanál na Discordu v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Co potřebujete

Každá lekce v tomto kurzu obsahuje ukázky kódu, které najdete ve složce code_samples. Můžete si [forknout tento repozitář](https://github.com/microsoft/ai-agents-for-beginners/fork) pro vytvoření vlastní kopie.

Ukázky kódu v těchto cvičeních používají Microsoft Agent Framework s Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Vyžaduje účet Azure

Tento kurz využívá následující AI Agent frameworky a služby od Microsoftu:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Pro více informací o spuštění kódu pro tento kurz přejděte na [Nastavení kurzu](./00-course-setup/README.md).
...
- Napsanou lekci umístěnou v README a krátké video
...
| Porozumění AI agentním návrhovým vzorům      | [Odkaz](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Návrhový vzor používání nástroje              | [Odkaz](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Víceagentní návrhový vzor                      | [Odkaz](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Metakognitivní návrhový vzor                   | [Odkaz](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Správa agentní paměti                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Prozkoumání Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Vytváření agentů pro používání počítače (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Nasazení škálovatelných agentů                    | Připravujeme                            |                                                            |                                                                                        |
| Vytváření lokálních AI agentů                     | Připravujeme                               |                                                            |                                                                                        |
| Zabezpečení AI agentů                           | Připravujeme                               |                                                            |                                                                                        |
...
Díky [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za přispění důležitých ukázek kódu demonstrujících Agentní RAG.

## Přispívání

Tento projekt vítá přispění a návrhy. Většina příspěvků vyžaduje, abyste souhlasili s
Licenční smlouvou přispěvatele (CLA), v níž deklarujete, že máte právo a skutečně
poskytujete nám práva k použití vašeho příspěvku. Podrobnosti najdete na <https://cla.opensource.microsoft.com>.

Když odešlete pull request, bot CLA automaticky zjistí, zda musíte poskytnout
CLA a podle toho PR označí (např. kontrola stavu, komentář). Postupujte podle pokynů
bota. Toto musíte provést pouze jednou ve všech repozitářích používajících naši CLA.

Tento projekt přijal [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Více informací najdete v [FAQ Kód chování](https://opensource.microsoft.com/codeofconduct/faq/) nebo
kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s dalšími otázkami či komentáři.

## Ochranné známky

Tento projekt může obsahovat ochranné známky nebo loga projektů, produktů nebo služeb. Autorizované používání ochranných známek či log Microsoftu podléhá a musí
dodržovat [Pokyny Microsoft pro ochranné známky a značky](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Jakékoliv použití ochranných známek nebo log třetích stran podléhá jejich pravidlům.

## Získání pomoci

Pokud narazíte na problémy nebo máte dotazy ohledně vývoje AI aplikací, připojte se k:
